...
export default async function PropertyDetails({ params }) {
  ...
  // fetch property directly from DB
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="bg-white border-b">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
          <Link href="/" className="inline-flex items-center text-sky-600 hover:text-sky-700 transition-colors">
          ...
          <div className="lg:col-span-1">
            <div className="bg-white rounded-lg shadow-md p-6">
              ...
              <div className="space-y-2 text-sm">
                <div className="flex justify-between"><span>ID:</span> <span className="font-medium">#{property._id}</span></div>
                <div className="flex justify-between"><span>Type:</span> <span className="font-medium">{property.type}</span></div>
                <div className="flex justify-between"><span>Furnishing:</span> <span className="font-medium">{property.furnishing}</span></div>
                <div className="flex justify-between"><span>Preference:</span> <span className="font-medium">{property.preference}</span></div>
              </div>
            </div>
          </div>
        </div>
